...
The goal of MDS is to find a lower dimensional set of vectors whose pairwise
Euclidean distances are as close as possible to the dissimilarity matrix of the
original vectors.
...
occur nearby to one another. Here are some example codes we can use:
