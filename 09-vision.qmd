...
::: {.callout-important}
Take note of where the origin is: at the top-left corner. The x-values increase
to the right from there; y-values increase downward from there.
:::
...
Image('data/football1.png', width=480)
```
