...
1.  From the Job satisfaction data in @exm-job-income-1, extract the standardised residuals (under
...
4.  For the Job satisfaction data in @exm-job-income-1, collapse the categories to obtain a 2-by-2
    table, and then compute a 95% confidence interval for the Odds Ratio from the 
    resulting table.
5.  Apply the Fisher Exact test to the the Job satisfaction data in @exm-job-income-1. How does it work
    in this case?
