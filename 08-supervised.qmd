...
*confusion matrix*. First we display the results for the training set.
...
### Example: Heart Failure Classification Scores II
...
First, we read the Taiwan data into Python and transform each column to have 
mean 0 and sd 1.
...
Here is the validation curve, that will allow us to decide on the optimal number 
of trees.
...
### Example: Taiwan Data Regression
